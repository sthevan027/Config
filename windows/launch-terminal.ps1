# Abre Windows Terminal em janela pequena (700x450) centralizada
Add-Type @"
using System;
...
$exe = "$env:LOCALAPPDATA\Microsoft\WindowsApps\wt.exe"
...
# WT abre WindowsTerminal.exe como processo filho
for ($i = 0; $i -lt 30; $i++) {
